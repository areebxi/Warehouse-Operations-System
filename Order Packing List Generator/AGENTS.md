...
Live paths via `shared/paths.py` (Data/config/I/O in this app; Tags + SharedInbox + ShipStation shared).
...
| `Data/Workbook.xlsx` (CL Database sheet archive-only) | `Data/New SKU Database.csv` |
