...
| `database/purchase-order-generator/` | Database, packs, stock CSVs |
| `database/shared/custom_label/Custom_Label_Database.csv` | Custom Label → BTC SKU |
| `database/shared/shipstation/ShipStation_Tags.xlsx` | Shared |
| `database/shared/product_export/ProductExport.csv` | Shared |
