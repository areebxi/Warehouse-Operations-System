...
**Updated:** 24 August 2026 (PE taxonomy fill 22:15)  
...
`Custom_Label_Database.csv` — **124,138** rows × **60** cols. PE taxonomy fill swapped onto live **24 Aug 22:17** after the file was closed. Fallback copy removed. Backup: `backups/Custom_Label_Database_preFill_20260824_221523.csv`.

Helpers: `support/Shirts Print Sizes.csv`, `support/Size References.csv`, `support/BTC Product Export.csv`, `support/Mocks Databse.csv`.

Main filler: `python scripts/fill_from_seeds.py` (steps: `sku`, `pe`, `suppliers`, `image`, `print`).
...
2. **Non-shirt Width 1 blanks** (~485 on 24 Aug): stickers, mugs, caps, bags, aprons, beanies, M251 / M290 / M307. Need Size References or an explicit override — not the shirt table.
