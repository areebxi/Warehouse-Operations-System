...
- Auto Missing Logo: `scripts/auto_missing_logo_watcher.py` watches Shared Inbox; folders from `queue_app_settings.json`; no approval; Processed/Failed under Shared Inbox.
